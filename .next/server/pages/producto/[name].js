...
function ImagesSlider({ colorSelected , product  }) {
    const [selectedImage, setSelectedImage] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(colorSelected.fullImage);
    const [gallery, setGallery] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([
        colorSelected.principalImage,
        colorSelected.reverseImage
    ]);
